...
const GoogleButtonState = styled.div`
...
const GoogleContentWrapper = styled.div`
  align-items: center;
  display: flex;
  flex-direction: row;
  flex-wrap: nowrap;
...
const GoogleButtonContents = styled.span`
  flex-grow: 0;
  font-family: 'Roboto', arial, sans-serif;
  font-weight: 500;
  overflow: hidden;
...
const GoogleButton = ({ buttonText, onClickHandler }) => {
  return (
    <GoogleButtonWrapper onClick={onClickHandler}>
      <GoogleButtonState className="gsi-material-button-state" />
      <GoogleContentWrapper className="gsi-material-button-content-wrapper">
        <GoogleIconWrapper className="gsi-material-button-icon">
          <svg
            version="1.1"
        ...
        <GoogleButtonContents className="gsi-material-button-contents">
          {buttonText}
